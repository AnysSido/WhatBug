...
{
    public class GetEditPermissionSchemeQueryValidator : AbstractValidator<GetEditPermissionSchemeQuery>
    {
        private IWhatBugDbContext _context;

        public GetEditPermissionSchemeQueryValidator(IWhatBugDbContext context)
        {
            _context = context;
        ...
        public async Task<bool> Exist(GetEditPermissionSchemeQuery query, int schemeId, CancellationToken cancellationToken)
        {
